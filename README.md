...
# Node 
Node is a server-side platform build on javascript (specifically googles javascript V8 engine) - this allows javascript to allow systems such as local filesystems. 
